                    ...
                    VStack(alignment: .leading) {
                        ...
                        HStack {
                            ...
                            DescriptionBox(title: "Metascore",
                                           value: viewModel.game!.metacritic != nil ?
                                            "\(viewModel.game!.metacritic!)" : "Not scored")
                            DescriptionBox(title: "Age Rating", value: "\(viewModel.game!.ageRating ?? "Not rated")")
                        }.padding(.bottom, 20)

                        DescriptionItem(title: "Genre", value: "\(viewModel.game!.genres.joined(separator: ", "))")
                        DescriptionItem(title: "Platform",
                                        value: "\(viewModel.game!.platforms.joined(separator: ", "))")
